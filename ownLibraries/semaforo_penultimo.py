...
class Real(Semaforo):
	...
	def find_color(self, imagen):
		...
		img = imagen
		cv2.imshow('red2.jpg', cv2.resize(img,(4*img.shape[1],4*img.shape[0])))
		...
		cv2.imshow('Acondicionado', cv2.resize(img,(4*img.shape[1],4*img.shape[0])))
...
if __name__ == '__main__':
	...
	while True:
		print(semaforo.blueprint_semaforo.encontrarSemaforoObtenerColor(poligono = poligono, imagen = img ))
		counter +=1
		print(counter)
		time.sleep(1)
